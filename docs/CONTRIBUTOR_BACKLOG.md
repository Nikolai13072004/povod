...
| FE-021 | P0 | DONE | Мелкие правки по отзыву: инициал имени в аватарке шапки (показывался только в профиле), «Выйти» стала настоящей кнопкой с обводкой (был `div` — не читался как нажимаемый и не доступен с клавиатуры), «Мои события» сведены к трём вкладкам с «Посещаю» первой, убрана линия под навигацией на широком экране. |
| FE-022 | P1 | READY | Подсказка города при вводе в профиле и на онбординге: сейчас поле свободное, и «Спб», «СПб», «Санкт-Петербург» становятся разными городами — фильтр по месту их не сводит. Нужен справочник (свой список или внешний сервис подсказок) с сохранением канонического названия. |
| FE-023 | P2 | READY | Пояснить переключатель «Следовать настройке системы» в профиле: из подписи не ясно, что он отдаёт выбор темы операционной системе. Нужна строка-описание под переключателем. |
| FE-024 | P1 | DONE | Leaflet перенесён из `unpkg.com` в сборку и грузится отложенно: CDN стоит за Cloudflare, который в России режет ответы до 16 КБ — карта не рисовалась вовсе, без единой ошибки. С онбординга убран блок «Количество человек»: он блокировал кнопку и никуда не сохранялся. |
...
| PROD-011 | P1 | DECISION | Чаты: вкладка в навигации есть, за ней пустой экран — ни списка, ни сообщений, ни API. Решить, писать полноценную переписку (сообщения, доставка, непрочитанные, история) или убрать вкладку и оставить обсуждение в комментариях под событием, которые уже работают. Владелец решает.
